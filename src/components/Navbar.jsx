...
import { Home, ListOrdered, Handshake, ChartScatter, CalendarClock } from "lucide-react"; // Import icons
      ...
      <ul className="nav-links">
        ...
        <li>
          <Link to="/matchhistory">
            {location.pathname === "/matchhistory" ? (
              <span className="nav-label">Match History</span>
            ) : (
